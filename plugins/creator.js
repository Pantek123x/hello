...
if (command == 'creator') {
  ...
  const sentMsg = await conn.sendContactArray(m.chat, [
    [`${nomorown}`, `${await conn.getName(nomorown+'@s.whatsapp.net')}`, `👑 Developer Bot `, `🚫 Don't call me 🥺`, `hendralubeck86@gmail.com`, `🇮🇩 Indonesia`, `🚀 https://chat.whatsapp.com/Fj5z7EXvGLVARaZ0cJF8rd.io/`, `👤 Gada pawang nih senggol dong 😔`],
